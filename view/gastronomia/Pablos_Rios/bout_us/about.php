<?php
$cssTime = filemtime('../../../view/gastronomia/Pablos_Rios/bout_us/about.css');
?>
	<link rel="stylesheet" href="../../../view/gastronomia/Pablos_Rios/bout_us/about.css?v=<?= $cssTime ?>">

	<main id="about_Pablos_Rios" class="wrap">
		<article class="card" itemscope itemtype="https://schema.org/LocalBusiness">
			<figure class="hero">
				<img src="../../../view/gastronomia/Pablos_Rios/img/lugar4.jpeg" alt="Pablos_Rios°" itemprop="image" loading="lazy">
