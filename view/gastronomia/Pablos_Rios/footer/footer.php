<?php
$cssTime = filemtime('../../../view/gastronomia/Pablos_Rios/footer/footer.css');
// $jsTime = filemtime('../../../');
?>
	<link rel="stylesheet" href="../../../view/gastronomia/Pablos_Rios/footer/footer.css?v=<?= $cssTime ?>">
		...
		<div class="footer_container">
			<div class="footer_social" aria-label="Redes sociales">
				<ul class="socials">
					...
					<li>
						<a href="https://www.instagram.com/Pablos_Rios/ " target="_blank" rel="noopener noreferrer" aria-label="Instagram">
