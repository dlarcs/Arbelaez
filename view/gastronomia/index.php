...
<head>
  ...
  <?php
    ...
    $jsTime  = filemtime('../../view/gastronomia/app.js');
  ?>
  <link rel="stylesheet" href="../../view/gastronomia/style.css?v=<?= $cssTime ?>">
  <script src="../../view/gastronomia/app.js?v=<?= $jsTime ?>" defer></script>
  ...
  <!-- Favicons -->
  <link rel="icon" type="image/png" sizes="32x32" href="../../view/gastronomia/Pablos_Restaurant/img/especial20.jpg">
  <link rel="icon" type="image/png" sizes="16x16" href="../../view/gastronomia/Pablos_Restaurant/img/especial20.jpg">
  <link rel="apple-touch-icon" sizes="180x180" href="../../view/gastronomia/Pablos_Restaurant/img/especial20.jpg">
  <link rel="mask-icon" href="../../view/gastronomia/Pablos_Restaurant/img/especial20.jpg" color="#005548">
