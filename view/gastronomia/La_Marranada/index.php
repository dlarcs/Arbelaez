...
<head>
  ...
  dónde comer en Arbeláez, planes en Arbeláez, restaurante con terraza Arbeláez">
	...
	<link rel="stylesheet" href="../../../view/gastronomia/La_Marranada/style.css">
	...
	<script type="application/ld+json">
		{
		    ...
		    "@type": "Restaurant",
		    "name": "La_Marranada ",
		    "url": "https://www.arbelaez.com.co/view/gastronomia/La_Marranada/index.php#restaurant",
		    "address": {
		      "@type": "PostalAddress",
...
<body class="body_La_Marranada">
	<?php include "../../../view/gastronomia/La_Marranada/menu/menu.php" ?>
	<div class="container_La_Marranada">
		<?php include "../../../view/gastronomia/La_Marranada/title/title.php" ?>
		<?php include "../../../view/gastronomia/La_Marranada/slider/slider.php" ?>
		<?php include "../../../view/gastronomia/La_Marranada/download/download.php" ?>
		<?php include "../../../view/gastronomia/La_Marranada/galery/gastronomia.php" ?>
		<?php include "../../../view/gastronomia/La_Marranada/bout_us/about.php" ?>
		<?php include "../../../view/gastronomia/La_Marranada/maps/maps.php"?>
	</div>
	<?php include "../../../view/gastronomia/La_Marranada/footer/footer.php" ?>
