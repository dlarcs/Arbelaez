...
<head>
  ...
  <!-- Icono / tema -->
  <link rel="icon" href="../../../view/gastronomia/Don_Ciprio/img/logo.png" type="image/png">
  ...
  <link rel="stylesheet" href="../../../view/gastronomia/Don_Ciprio/style.css">
...
<body class="body_Don_Ciprio">
  ...
  <div class="container_Don_Ciprio">
    <?php include "../../../view/gastronomia/Don_Ciprio/title/title.php" ?>
    <?php include "../../../view/gastronomia/Don_Ciprio/slider/slider.php" ?>
    <?php include "../../../view/gastronomia/Don_Ciprio/download/download.php" ?>
    <?php include "../../../view/gastronomia/Don_Ciprio/galery/gastronomia.php" ?>
    <?php include "../../../view/gastronomia/Don_Ciprio/bout_us/about.php" ?>
    <?php include "../../../view/gastronomia/Don_Ciprio/maps/maps.php"?>
  </div>
  <?php include "../../../view/gastronomia/Don_Ciprio/footer/footer.php" ?>
