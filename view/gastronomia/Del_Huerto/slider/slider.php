<?php
$cssTime = filemtime('../../../view/gastronomia/Del_Huerto/slider/slider.css');
$jsTime = filemtime('../../../view/gastronomia/Del_Huerto/slider/slider.js');
?>
	<link rel="stylesheet" href="../../../view/gastronomia/Del_Huerto/slider/slider.css?v=<?= $cssTime ?>">
		...
		<div class="slider__viewport" tabindex="0">
			<div class="slider__track" id="slider-track">
				...
				<article class="slide is-current" aria-role description="slide" aria-label="1 de 4">
					<img src="../../../view/gastronomia/Del_Huerto/img/pizza6.jpg" alt="Montañas al amanecer" />
           ...
           <p>Descubre el amor que transforma vidas.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="2 de 4">
					<img src="../../../view/gastronomia/Del_Huerto/img/pizza1.jpg" alt="Bosque con luz dorada" />
					<div class="slide__caption">
           ...
           <p>Aquí siempre encontrarás un lugar para ti.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="3 de 4">
					<img src="../../../view/gastronomia/Del_Huerto/img/pizza2.jpg" alt="Lago tranquilo" />
					<div class="slide__caption">
           ...
           <p>Cristo es la luz en medio de la oscuridad.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="4 de 4">
					<img src="../../../view/gastronomia/Del_Huerto/img/pizza4.jpg" alt="Carretera hacia el horizonte" />
					<div class="slide__caption">
	...
	<script src="../../../view/gastronomia/Del_Huerto/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
