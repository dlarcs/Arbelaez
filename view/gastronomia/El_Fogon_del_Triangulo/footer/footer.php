<?php
$cssTime = filemtime('../../../view/gastronomia/El_Fogon_del_Triangulo/footer/footer.css');
?>
	<link rel="stylesheet" href="../../../view/gastronomia/El_Fogon_del_Triangulo/footer/footer.css?v=<?= $cssTime ?>">
