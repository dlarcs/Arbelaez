<?php
$cssTime = filemtime('../../../view/gastronomia/El_Fogon_del_Triangulo/bout_us/about.css');
?>
	<link rel="stylesheet" href="../../../view/gastronomia/El_Fogon_del_Triangulo/bout_us/about.css?v=<?= $cssTime ?>">

	<main id="about_El_Fogon_triangulo" class="wrap">
		<article class="card" itemscope itemtype="https://schema.org/LocalBusiness">
			<figure class="hero">
				<img src="../../../view/gastronomia/El_Fogon_del_Triangulo/img/logo.png" alt="El_Fogon_triangulo" itemprop="image" loading="lazy">
