...
<head>
  ...
  <!-- Icono / tema -->
  <link rel="icon" href="../../../view/gastronomia/El_Fogon_del_Triangulo/img/logo.png" type="image/png">
...
<body class="body_El_Fogon_del_triangulo">
  <?php include "../../../view/gastronomia/El_Fogon_del_Triangulo/menu/menu.php" ?>
  <div class="container_El_Fogon_del_triangulo">
    <?php include "../../../view/gastronomia/El_Fogon_del_Triangulo/title/title.php" ?>
    <?php include "../../../view/gastronomia/El_Fogon_del_Triangulo/slider/slider.php" ?>
    <?php include "../../../view/gastronomia/El_Fogon_del_Triangulo/download/download.php" ?>
    <?php include "../../../view/gastronomia/El_Fogon_del_Triangulo/galery/gastronomia.php" ?>
