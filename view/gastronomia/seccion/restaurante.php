...
?>
  ...
  $cssTime = filemtime('../../view/gastronomia/seccion/restaurantes.css');
  $jsTime  = filemtime('../../view/gastronomia/seccion/restaurantes.js');
  ...
  $restos = [
    [
      'name'         => 'Kapaluna 360°',
      'slug'         => 'kapaLuna360',
      'img'          => '../../view/gastronomia/img/kapa_luna.jpg',
      'img_alt'      => 'Kapaluna 360°: terraza gastro-bar con parrilla y coctelería de autor',
      'zone'         => 'Pueblo', // para el filtro (Pueblo / Vereda)
      'schema'       => 'Restaurant',
    ...
    [
      'name'         => 'Kalú',
      'slug'         => 'kalu',
      'img'          => '../../view/gastronomia/img/kalu.jpg',
    ...
    [
      ...
      'zone'         => 'Vereda', // aquí lo pongo como Vereda para que el filtro tenga sentido
      'schema'       => 'Restaurant',
      'location'     => 'En vereda',
