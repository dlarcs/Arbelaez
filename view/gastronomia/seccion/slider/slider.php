<?php
$cssTime = filemtime('../../view/gastronomia/seccion/slider/slider.css');
$jsTime = filemtime('../../view/gastronomia/seccion/slider/slider.js');
?>
<link rel="stylesheet" href="../../view/gastronomia/seccion/slider/slider.css?v=<?= $cssTime ?>">
   ...
   <div class="slider__viewport" tabindex="0">
     <div class="slider__track" id="slider-track">
       ...
       <article class="slide is-current" aria-roledescription="slide" aria-label="1 de 4">
         <img src="../../view/gastronomia/La_Marranada/img/especial8.jpg"
       ...
       <article class="slide" aria-roledescription="slide" aria-label="2 de 4">
         <img src="../../view/gastronomia/kalu/img/especial10.jpg"
       ...
       <article class="slide" aria-roledescription="slide" aria-label="3 de 4">
         <img src="../../view/gastronomia/Pablos_Restaurant/img/especial17.jpg"
              alt="Lago tranquilo" />
         <div class="slide__caption">
       ...
       <article class="slide" aria-roledescription="slide" aria-label="4 de 4">
         <img src="../../view/gastronomia/img/pablos1.jpeg"
...
<script src="../../view/gastronomia/seccion/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
