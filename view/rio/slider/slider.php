<?php
$cssTime = filemtime('../../view/rio/slider/slider.css');
$jsTime = filemtime('../../view/rio/slider/slider.js');
?>
<link rel="stylesheet" href="../../view/rio/slider/slider.css?v=<?= $cssTime ?>">
...
<script src="../../view/rio/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
