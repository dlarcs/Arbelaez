<?php
$cssTime = filemtime('../../view/Naturaleza/slider/slider.css');
$jsTime = filemtime('../../view/Naturaleza/slider/slider.js');
?>
<link rel="stylesheet" href="../../view/Naturaleza/slider/slider.css?v=<?= $cssTime ?>">
   ...
   <div class="slider__viewport" tabindex="0">
     <div class="slider__track" id="slider-track">
       ...
       <article class="slide is-current" aria-roledescription="slide" aria-label="1 de 4">
         <img src="../../view/Parroquia/img/techo_iglesia.jpg"
       ...
       <article class="slide" aria-roledescription="slide" aria-label="2 de 4">
         <img src="../../view/Parroquia/img/estatuas.jpg"
       ...
       <article class="slide" aria-roledescription="slide" aria-label="3 de 4">
         <img src="../../view/Parroquia/img/iglesia1.jpg"
              alt="Lago tranquilo" />
         <div class="slide__caption">
       ...
       <article class="slide" aria-roledescription="slide" aria-label="4 de 4">
         <img src="../../view/Parroquia/img/sillas_iglesia2.jpg"
...
<script src="../../view/Naturaleza/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
