...
<section class="section_pag_places" aria-labelledby="galeria-title">
  ...
  <nav class="categories_pag_places" aria-label="Filtros de galería">
    <ul>
      ...
      <li class="filter_items" data-filter="pag_places">Paisajes</li>
    </ul>
  </nav>
  ...
  <div class="img_galery_pag_places">
    ...
    <!-- ====== EQUINOS ====== -->
    <a class="card_link" href="https://www.facebook.com/people/Arbelaez-Turismo/61580302286594/" target="_blank" rel="noopener" aria-label="Ver en Facebook: Feria equina">
      <figure class="galery_card_pag_places equinos" data-cat="equinos">
        ...
        <div class="overlay_pag_places" aria-hidden="true">
          <figcaption class="card_info_pag_places"><p>Click para ir a Facebook</p></figcaption>
        </div>
      </figure>
    </a>
    ...
    <!-- ====== FLORES (1..14) ====== -->
    <a class="card_link" href="https://www.facebook.com/people/Arbelaez-Turismo/61580302286594/" target="_blank" rel="noopener" aria-label="Ver en Facebook: Flores">
    ...
    <a class="card_link" href="https://www.facebook.com/people/Arbelaez-Turismo/61580302286594/" target="_blank" rel="noopener" aria-label="Ver en Facebook: Paisaje">
