<?php
$cssTime = filemtime('../../../view/artesanias/Artesanas_Veredas/footer/footer.css');
// $jsTime = filemtime('../../../');
?>
	<link rel="stylesheet" href="../../../view/artesanias/Artesanas_Veredas/footer/footer.css?v=<?= $cssTime ?>">
