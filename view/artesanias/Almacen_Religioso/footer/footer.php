<?php
$cssTime = filemtime('../../../view/artesanias/Almacen_Religioso/footer/footer.css');
// $jsTime = filemtime('../../../');
?>
	<link rel="stylesheet" href="../../../view/artesanias/Almacen_Religioso/footer/footer.css?v=<?= $cssTime ?>">
