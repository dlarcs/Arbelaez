<?php
$cssTime = filemtime('../../view/Radio/footer/footer.css');
// $jsTime = filemtime('../../../');
?>
	<link rel="stylesheet" href="../../view/Radio/footer/footer.css?v=<?= $cssTime ?>">
	<section class="seccion_footer">
		...
		<div class="footer_container">
			<div class="footer_social" aria-label="Redes sociales">
				<ul class="socials">
					<li>
						<a href="https://wa.me/5" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
		...
		<div class="footer_bottom">
			...
			<a href="https://www.tu-enlace.com" target="_blank" rel="noopener noreferrer">
