<?php
$cssTime = filemtime('../../view/Juntanza_de_Mujeres/footer/footer.css');
// $jsTime = filemtime('../../');
?>
	<link rel="stylesheet" href="../../view/Juntanza_de_Mujeres/footer/footer.css?v=<?= $cssTime ?>">
	<section class="seccion_footer">
		...
		<div class="footer_container">
			<div class="footer_social" aria-label="Redes sociales">
				<ul class="socials">
					<li>
						<a href="https://www.instagram.com/Juntanza_de_Mujeres/ " target="_blank" rel="noopener noreferrer" aria-label="Instagram">
