<?php
$cssTime = filemtime('../../../view/alojamiento/Casa_Kiyari/menu/menu.css'); // ejemplo: '../Home/5.Video/video.css'
?>
	<link rel="stylesheet" href="../../../view/alojamiento/Casa_Kiyari/menu/menu.css?v=<?= $cssTime ?>">
