<?php
$cssTime = filemtime('../../../view/alojamiento/Casa_Kiyari/footer/footer.css');
// $jsTime = filemtime('../../../');
?>
	<link rel="stylesheet" href="../../../view/alojamiento/Casa_Kiyari/footer/footer.css?v=<?= $cssTime ?>">
	<section class="seccion_footer">
		...
		<div class="footer_container">
			<div class="footer_social" aria-label="Redes sociales">
				<ul class="socials">
					<li>
						<a href="https://www.instagram.com/casakiyaricolombia/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
