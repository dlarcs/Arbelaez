<?php
$cssTime = filemtime('../../../view/alojamiento/Casa_Colibri/footer/footer.css');
// $jsTime = filemtime('../../../');
?>
	<link rel="stylesheet" href="../../../view/alojamiento/Casa_Colibri/footer/footer.css?v=<?= $cssTime ?>">
	<section class="seccion_footer">
		...
		<div class="footer_container">
			<div class="footer_social" aria-label="Redes sociales">
				<ul class="socials">
					<li>
						<a href="https://www.facebook.com/share/17EQnAxDSg/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
							<ion-icon name="logo-facebook"></ion-icon><span class="sr-only">Facebook</span>
						</a>
					</li>
					<li>
				    <a href="https://www.instagram.com/casacolibriARBELÁEZ/?utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
