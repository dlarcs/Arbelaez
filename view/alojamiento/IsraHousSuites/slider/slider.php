<?php
$cssTime = filemtime('../../../view/alojamiento/IsraHousSuites/slider/slider.css');
$jsTime = filemtime('../../../view/alojamiento/IsraHousSuites/slider/slider.js');
?>
	<link rel="stylesheet" href="../../../view/alojamiento/IsraHousSuites/slider/slider.css?v=<?= $cssTime ?>">
		...
		<div class="slider__viewport" tabindex="0">
			<div class="slider__track" id="slider-track">
				...
				<article class="slide is-current" aria-role description="slide" aria-label="1 de 4">
					<img src="../../../view/alojamiento/IsraHousSuites/img/exterior.jpeg" alt="Artesanías" />
           ...
           <p>Descubre el amor que transforma vidas.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="2 de 4">
					<img src="../../../view/alojamiento/IsraHousSuites/img/exterior2.jpeg" alt="Artesanías" />
					<div class="slide__caption">
           ...
           <p>Aquí siempre encontrarás un lugar para ti.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="3 de 4">
					<img src="../../../view/alojamiento/IsraHousSuites/img/exterior1.jpeg" alt="Artesanías" />
					<div class="slide__caption">
           ...
           <p>Cristo es la luz en medio de la oscuridad.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="4 de 4">
					<img src="../../../view/alojamiento/IsraHousSuites/img/fachada.jpeg" alt="Artesanías" />
					<div class="slide__caption">
	...
	<script src="../../../view/alojamiento/IsraHousSuites/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
