<?php
$cssTime = filemtime('../../view/alojamiento/seccion/slider/slider.css');
$jsTime = filemtime('../../view/alojamiento/seccion/slider/slider.js');
?>
<link rel="stylesheet" href="../../view/alojamiento/seccion/slider/slider.css?v=<?= $cssTime ?>">
   ...
   <div class="slider__viewport" tabindex="0">
     <div class="slider__track" id="slider-track">
       ...
       <article class="slide is-current" aria-roledescription="slide" aria-label="1 de 4">
         <img src="../../view/alojamiento/img/casa_kandu.jpg"
              alt="Montañas al amanecer" />
         <div class="slide__caption">
           <p>Duerme con tranquilidad</p>
         </div>
       </article>
       <!-- Slide 2 -->
       ...
       <article class="slide" aria-roledescription="slide" aria-label="3 de 4">
         <img src="../../view/alojamiento/Cachorros_LyC/img/trago.jpg"
              alt="Lago tranquilo" />
         <div class="slide__caption">
           <p>Comodidad y más</p>
         </div>
       ...
       <article class="slide" aria-roledescription="slide" aria-label="4 de 4">
         <img src="../../view/alojamiento/Turismo_Hoy_Vivo/img/Casa_rural1.jpg"
...
<script src="../../view/alojamiento/seccion/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
