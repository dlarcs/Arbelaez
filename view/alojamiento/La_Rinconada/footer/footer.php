<?php
$cssTime = filemtime('../../../view/alojamiento/La_Rinconada/footer/footer.css');
// $jsTime = filemtime('../../../');
?>
	<link rel="stylesheet" href="../../../view/alojamiento/La_Rinconada/footer/footer.css?v=<?= $cssTime ?>">
	<section class="seccion_footer">
		...
		<div class="footer_container">
			<div class="footer_social" aria-label="Redes sociales">
				<ul class="socials">
					<li>
						<a href="https://www.facebook.com/profile.php?id=61579167031484" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
