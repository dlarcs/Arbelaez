<?php
$cssTime = filemtime('../../../view/alojamiento/Turismo_Hoy_Vivo/menu/menu.css'); // ejemplo: '../Home/5.Video/video.css'
?>
	<link rel="stylesheet" href="../../../view/alojamiento/Turismo_Hoy_Vivo/menu/menu.css?v=<?= $cssTime ?>">
  ...
  <nav id="site-nav" class="nav">
    <ul class="nav-list">
      ...
      <li><a href="#ubicacion_Turismo_Hoy_Vivo">Ubicación</a></li>
