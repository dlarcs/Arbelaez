<?php
$cssTime = filemtime('../../view/Proyectos_Arbelaez/menu/menu.css'); // ejemplo: '../Home/5.Video/video.css'
?>
	<link rel="stylesheet" href="../../view/Proyectos_Arbelaez/menu/menu.css?v=<?= $cssTime ?>">
