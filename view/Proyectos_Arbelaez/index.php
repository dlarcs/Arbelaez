...
<head>
  ...
  <meta name="description" content="Página para promover el turismo de Arbeláez (Cundinamarca) a través de actividades y Proyectos_Arbelaez que visibilizan lo mejor del municipio: cultura, gastronomía, naturaleza, emprendimientos y experiencias locales.">
  <link rel="canonical" href="https://www.arbelaez.com.co/view/Proyectos_Arbelaez/index.php">
  ...
  <?php $cssTime = filemtime('../../view/Proyectos_Arbelaez/style.css'); ?>
  <link rel="stylesheet" href="../../view/Proyectos_Arbelaez/style.css?v=<?= $cssTime ?>">
  ...
  <script type="application/ld+json">
  {
    ...
    "url": "https://www.arbelaez.com.co/view/Proyectos_Arbelaez/index.php",
    "address": {
      "@type": "PostalAddress",
    ...
    "description": "Página para promover el turismo de Arbeláez mediante actividades y Proyectos_Arbelaez que visibilizan la cultura, la gastronomía, la naturaleza y el talento local. Aquí encontrarás iniciativas actuales y futuras para mostrar lo lindo y el potencial del municipio."
  }
  </script>
</head>

<body class="body_Proyectos_Arbelaez">
  <?php include "../../view/Proyectos_Arbelaez/menu/menu.php" ?>

  <div class="container_Proyectos_Arbelaez">
    <?php include "../../view/Proyectos_Arbelaez/title/title.php" ?>
    <?php include "../../view/Proyectos_Arbelaez/slider/slider.php" ?>
    <?php include "../../view/Proyectos_Arbelaez/galery/arte.php" ?>
    <?php include "../../view/Proyectos_Arbelaez/bout_us/about.php" ?>
    <?php include "../../view/Proyectos_Arbelaez/maps/maps.php"?>
  </div>

  <?php include "../../view/Proyectos_Arbelaez/footer/footer.php" ?>
</body>
</html>
