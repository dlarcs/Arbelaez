<?php
$cssTime = filemtime('../../view/Parroquia/slider/slider.css');
$jsTime = filemtime('../../view/Parroquia/slider/slider.js');
?>
...
<script src="../../view/Parroquia/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
