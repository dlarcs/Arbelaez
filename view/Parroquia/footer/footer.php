<?php
$cssTime = filemtime('../../view/Parroquia/footer/footer.css');
?>
	<link rel="stylesheet" href="../../view/Parroquia/footer/footer.css?v=<?= $cssTime ?>">
	<section class="seccion_footer">
		...
		<div class="footer_container">
			<div class="footer_social" aria-label="Redes sociales">
				<ul class="socials">
					<li>
						<a href="https://www.facebook.com/parroquiainmaculadaconcepciondearbelaez.arbelaez" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
