<?php
$cssTime = filemtime('../../view/festividades/seccion/slider/slider.css');
$jsTime = filemtime('../../view/festividades/seccion/slider/slider.js');
?>
<link rel="stylesheet" href="../../view/festividades/seccion/slider/slider.css?v=<?= $cssTime ?>">
   ...
   <div class="slider__viewport" tabindex="0">
     <div class="slider__track" id="slider-track">
       ...
       <article class="slide is-current" aria-roledescription="slide" aria-label="1 de 4">
         <img src="../../view/festividades/la_diablada/diablada15.JPG"
       ...
       <article class="slide" aria-roledescription="slide" aria-label="2 de 4">
         <img src="../../view/festividades/img_christi/christi10.jpeg"
       ...
       <article class="slide" aria-roledescription="slide" aria-label="3 de 4">
         <img src="../../view/festividades/la_diablada/diablada9.JPG"
              alt="Lago tranquilo" />
         <div class="slide__caption">
           <p>La diablada</p>
         </div>
       ...
       <article class="slide" aria-roledescription="slide" aria-label="4 de 4">
         <img src="../../view/festividades/img_christi/christi8.jpeg"
...
<script src="../../view/festividades/seccion/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
