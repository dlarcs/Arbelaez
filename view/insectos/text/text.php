<?php
$cssTime = filemtime('../../view/insectos/text/text.css'); // ejemplo: '../Home/5.Video/video.css'
$jsTime = filemtime('../../view/insectos/text/text.js');
?>
<link rel="stylesheet" href="../../view/insectos/text/text.css?v=<?= $cssTime ?>">
...
<script src="../../view/insectos/text/text.js?v=<?= $jsTime ?>" type="text/javascript"></script>
