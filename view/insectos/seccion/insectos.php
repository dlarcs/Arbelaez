<?php
$cssTime = filemtime('../../view/insectos/seccion/insectos.css');
$jsTime = filemtime('../../view/insectos/seccion/insectos.js');
?>
<link rel="stylesheet" href="../../view/insectos/seccion/insectos.css?v=<?= $cssTime ?>">

<section class="seccion_insectos">
...
<section>
  ...
  <main class="page">
    <sectioner class="hero">
      ...
      <p class="hero__subtitle">Descubre la belleza de las insectos a través de fotografías excepcionales</p>
    ...
    <section class="gallery" aria-label="Galería de insectos">
...
<script src="../../view/insectos/seccion/insectos.js?v=<?= $jsTime ?>" type="text/javascript"></script>
