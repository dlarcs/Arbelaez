...
<head>
  ...
  <link rel="canonical" href="https://www.arbelaez.com.co/artesanias/Artesanas_Veredas/index.php">
...
<body class="body_Artesanas_Veredas">
  <?php include "../../../artesanias/Artesanas_Veredas/menu/menu.php" ?>
  <div class="container_Artesanas_Veredas">
    <?php include "../../../artesanias/Artesanas_Veredas/title/title.php" ?>
    <?php include "../../../artesanias/Artesanas_Veredas/slider/slider.php" ?>
    <?php include "../../../artesanias/Artesanas_Veredas/galery/arte.php" ?>
    <?php include "../../../artesanias/Artesanas_Veredas/bout_us/about.php" ?>
    <?php include "../../../artesanias/Artesanas_Veredas/maps/maps.php"?>
  </div>
  <?php include "../../../artesanias/Artesanas_Veredas/footer/footer.php" ?>
</body>
</html>
