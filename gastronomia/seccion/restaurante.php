...
?>
  ...
  $restos = [
    [
      ...
      'name'         => 'Los Andariegos',
      'slug'         => 'Los_Andariegos',
      'img'          => '../gastronomia/Los_Andariegos/img/logo.jpeg',
      'img_alt'      => 'Carne a la llanera, rellena, chunchullo, sobrebarriga',
      'zone'         => 'Vereda',
      'schema'       => 'CafeOrCoffeeShop',
      'location'     => 'En vereda',
      'desc'         => 'Los Andariegos, carne a la llanera, sopas, parrilla y recetas especiales en un espacio acogedor para compartir, descansar y disfrutar tranquilamente en Arbeláez.',
      'servesCuisine'=> '',
      'features'     => [
