<?php
$cssTime = filemtime('../../gastronomia/Los_Andariegos/slider/slider.css');
$jsTime = filemtime('../../gastronomia/Los_Andariegos/slider/slider.js');
?>
	<link rel="stylesheet" href="../../gastronomia/Los_Andariegos/slider/slider.css?v=<?= $cssTime ?>">
		...
		<div class="slider__viewport" tabindex="0">
			<div class="slider__track" id="slider-track">
				...
				<article class="slide is-current" aria-role description="slide" aria-label="1 de 4">
					<img src="../../gastronomia/Los_Andariegos/img/almuerzo.jpeg" alt="Montañas al amanecer" loading="lazy" decoding="async" />
           ...
           <p>Descubre el amor que transforma vidas.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="2 de 4">
					<img src="../../gastronomia/Los_Andariegos/img/almuerzo7.jpeg" alt="Bosque con luz dorada" loading="lazy" decoding="async" />
					<div class="slide__caption">
           ...
           <p>Aquí siempre encontrarás un lugar para ti.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="3 de 4">
					<img src="../../gastronomia/Los_Andariegos/img/sopas.jpeg" alt="Lago tranquilo" loading="lazy" decoding="async" />
					<div class="slide__caption">
           ...
           <p>Cristo es la luz en medio de la oscuridad.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="4 de 4">
					<img src="../../gastronomia/Los_Andariegos/img/general6.jpeg" alt="Carretera hacia el horizonte" loading="lazy" decoding="async" />
					<div class="slide__caption">
	...
	<script src="../../gastronomia/Los_Andariegos/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
