<?php
$cssTime = filemtime('../../gastronomia/Pablos_Restaurant/slider/slider.css');
$jsTime = filemtime('../../gastronomia/Pablos_Restaurant/slider/slider.js');
?>
	<link rel="stylesheet" href="../../gastronomia/Pablos_Restaurant/slider/slider.css?v=<?= $cssTime ?>">
		...
		<div class="slider__viewport" tabindex="0">
			<div class="slider__track" id="slider-track">
				...
				<article class="slide is-current" aria-role description="slide" aria-label="1 de 4">
					<img src="../../gastronomia/Pablos_Restaurant/img/lugar4.jpeg" alt="Montañas al amanecer" />
           ...
           <p>Descubre el amor que transforma vidas.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="2 de 4">
					<img src="../../gastronomia/Pablos_Restaurant/img/jugo2.jpg" alt="Bosque con luz dorada" />
					<div class="slide__caption">
           ...
           <p>Aquí siempre encontrarás un lugar para ti.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="3 de 4">
					<img src="../../gastronomia/Pablos_Restaurant/img/lugar7.jpeg" alt="Lago tranquilo" />
					<div class="slide__caption">
           ...
           <p>Cristo es la luz en medio de la oscuridad.</p> -->
				...
				<article class="slide" aria-role description="slide" aria-label="4 de 4">
					<img src="../../gastronomia/Pablos_Restaurant/img/especial5.jpeg" alt="Carretera hacia el horizonte" />
					<div class="slide__caption">
	...
	<script src="../../gastronomia/Pablos_Restaurant/slider/slider.js?v=<?= $jsTime ?>" type="text/javascript"></script>
