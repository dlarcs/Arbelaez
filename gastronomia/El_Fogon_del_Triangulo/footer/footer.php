<?php
$cssTime = filemtime('../../gastronomia/El_Fogon_del_Triangulo/footer/footer.css');
?>
	<link rel="stylesheet" href="../../gastronomia/El_Fogon_del_Triangulo/footer/footer.css?v=<?= $cssTime ?>">
